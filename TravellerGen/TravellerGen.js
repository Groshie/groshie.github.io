// The Mongoose Traveller Encounter Calculator
console.log("Written by: Groshie, 2019")
...
function rollD66() {
	var thisRoll = "";
	return thisRoll.concat(rand(1, 6), rand(1, 6))
}

function makeMainPlot() {
	var mainPlot = "<p>" + nameList[rand(0, nameList.length)];
	mainPlot += " " + nameList[rand(0, nameList.length)];
	mainPlot += ", " + adjectiveList[rollD66()];
	mainPlot += " " + patronTable[rollD66()];
	mainPlot += " who wants to ";
	mainPlot += missionTable[rollD66()];
	mainPlot += ", makes contact.</p><p>Their goal is to get ahold of ";
	mainPlot += targetTable[rollD66()];
	mainPlot += " but they are hindered by "
	mainPlot += oppositionTable[rollD66()] + ".</p>"
	return mainPlot
}

function makeSubChar() {
	var subCharStr = "- " + nameList[rand(0, nameList.length)];
	subCharStr += " " + nameList[rand(0, nameList.length)];
	subCharStr += ", " + adjectiveList[rollD66()];
	subCharStr += " " + npcTable[rollD66()];
	subCharStr += " " + traitTable[rollD66()];
	return subCharStr
}

function onLoad() {
	document.getElementById("mainPlot").innerHTML = makeMainPlot();
	var subChars = "";
	for (i=0;i<5;i++) {
		subChars += makeSubChar() + "<br>"
	}
	document.getElementById("subChars").innerHTML = subChars;
	var subEvents = "- " + randomEncounters["Starport"][rollD66()] + "<br>";
	subEvents += "- " + randomEncounters["Rural"][rollD66()] + "<br>";
	subEvents += "- " + randomEncounters["Urban"][rollD66()];
	document.getElementById("subEvents").innerHTML = subEvents;
	return
}


//Tables
patronCategory = ["All", "Criminal", "Local leader", "High society", "Commercial", "Spacer", "Unusual"];
targetCategory = ["All", "Trade goods", "Objects", "Places", "NPCs", "Organisations", "Vessels"];
oppositionCategory = ["All", "Low tech", "Average tech", "High tech", "Environmental", "Technology", "Social"];

//Namelist is from https://github.com/dominictarr/random-name/blob/master/names.json
nameList = [
"Aaberg"
,
"Aalst"
...
traitTable = {
	11: "who is loyal",
	12: "who is distracted by other worries",
	13: "who is in debt to criminals",
	14: "who makes very bad jokes",
	15: "who will betray characters",
	16: "who is aggressive",
	21: "who has secret allies",
	22: "who is a secret anagathic user",
	23: "who is looking for something",
	24: "who is helpful",
	25: "who is forgetful",
	26: "who wants to hire the characters",
	31: "who has useful contacts",
	32: "who is artistic",
	33: "who is easily confused",
	34: "who is unusually ugly",
	35: "who is worried about a current situation",
	36: "who shows pictures of his children",
	41: "who is a rumour-monger",
	42: "who is unusually provincial",
	43: "who is a drunkard or a drug addict",
	44: "who is a government informant",
	45: "who mistakes a player character for someone else",
	46: "who possesses unusually advanced technology",
	51: "who is unusually handsome or beautiful",
	52: "who is spying on the characters",
	53: "who possesses a TAS membership",
	54: "who is secretly hostile towards the characters",
	55: "who wants to borrow money",
	56: "who is convinced the characters are dangerous",
	61: "who is involved in political intrigue",
	62: "who has a dangerous secret",
	63: "who wants to get offplanet as soon as possible",
	64: "who is attracted to a player character",
	65: "who is from offworld",
	66: "who possesses telepathy or other unusual quality"
};
...
missionTable = {
	...
	64: "save a target",
	65: "aid a target",
	66: "trap or betray the characters"
};
...
oppositionTable = {
	...
	16: "a local lord",
	21: "thugs or corsairs",
	22: "thieves or saboteurs",
	23: "ordinary security forces",
	24: "police inspectors and detectives",
	25: "corporate agents",
	26: "corporate legal division",
	31: "starport security",
	32: "imperial marines",
	33: "an interstellar corporation",
	34: "aliens (a private citizen or an alien corporation)",
	35: "an alien government",
	36: "space travellers or a rival ship",
	41: "that the target is in deep space",
	42: "that the target is in orbit",
	43: "hostile weather conditions",
	44: "dangerous organisms or radiation",
	45: "that the target is in a dangerous region",
	46: "that the target is in a restricted area",
	51: "that the target is under electronic observation",
	52: "hostile guard robots or ships",
	53: "that biometric identification required",
	54: "mechanical failure or computer hacking",
	55: "that the characters are under surveillance",
	56: "that they are out of fuel or ammunition",
	61: "a police investigation",
	62: "Legal barriers",
	63: "nobility",
	64: "government officials",
	65: "that the target is protected by a third party",
	66: "hostages"
};
...
targetTable = {
	...
	32: "an asteroid base",
	33: "a city",
	34: "a research station",
	35: "a bar or nightclub",
	36: "a medical facility",
	41: patronTable[rollD66()],
	42: patronTable[rollD66()],
	43: patronTable[rollD66()],
	44: oppositionTable[rollD66()],
	45: oppositionTable[rollD66()],
	46: oppositionTable[rollD66()],
	51: "a local government",
	52: "a planetary government",
	53: "a corporation",
	54: "imperial intelligence",
	55: "a criminal syndicate",
	56: "a criminal gang",
	61: "a free trader",
	62: "a yacht",
	63: "a cargo hauler",
...
randomEncounters = {
	...
	"Urban": {
		...
		51: "Characters spot someone they recognise",
